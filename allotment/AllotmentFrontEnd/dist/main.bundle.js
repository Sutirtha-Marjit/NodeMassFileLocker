...
module.exports = "<div class=\"dest-contain-wrap\">\r\n  \r\n  <div class=\"container-fluid\">\r\n    <div>\r\n    <h2>Browse</h2>\r\n    <h6>\r\n    <a *ngIf=\"browsePath.length!==0\"  (click)=\"resetBrowawePath()\" class=\"btn btn-sm btn-success\" href=\"#\">Clean & Browse Again</a>\r\n    <a *ngIf=\"browsePath.length!==0\">&nbsp;<span>{{browsePath}}</span></a>\r\n    </h6>\r\n    <hr/>\r\n  </div>\r\n    <div class=\"row col-row\" *ngIf=\"browsePath.length!==0\">\r\n        <div class=\"col col-pic\" *ngFor=\"let set of this.browsedData.list\">\r\n          <div *ngFor=\"let item of set\">\r\n            <div class=\"dir-element\" *ngIf=\"item.isDir\"></div> \r\n            <div class=\"pic-element\" *ngIf=\"!item.isDir\">\r\n              <img alt=\"{{item.filename}}\" src=\"{{item.path}}\"/>              \r\n            </div> \r\n          </div>  \r\n        </div>\r\n    </div>  \r\n\r\n    <div class=\"row\" *ngIf=\"browsePath.length===0\">\r\n      <div class=\"col\" *ngFor=\"let rootContainer of geArrayVersionOfGivenContainers();\">\r\n        <h3>{{rootContainer.key}}</h3>\r\n        <div *ngFor=\"let listitem of rootContainer.val; let i = index;\">\r\n      <ol  class=\"breadcrumb\">\r\n        <li class=\"breadcrumb-item\">\r\n          <a (click)=\"setBrowsePath(rootContainer.key+'/'+listitem.name)\" href=\"#\" class=\"btn btn-sm btn-dark\"><span class=\"folder-icon-small\"></span><span class=\"folder-name\">{{listitem.name}}</span></a>\r\n        </li>        \r\n      </ol>\r\n      <ol class=\"breadcrumb\" *ngFor=\"let sublistItem of listitem.childrenDetails\">\r\n        <li class=\"breadcrumb-item\">\r\n          <a>{{listitem.name}}</a>\r\n        </li>\r\n        <li class=\"breadcrumb-item\">\r\n          <a href=\"#\" (click)=\"setBrowsePath(rootContainer.key+'/'+listitem.name+'/'+sublistItem)\" class=\"btn btn-sm btn-dark\">{{sublistItem}}</a>\r\n        </li>        \r\n      </ol>\r\n      </div>\r\n      </div> \r\n   \r\n    </div>\r\n  </div>\r\n \r\n <div class=\"cross-button\" title=\"Close this\" (click)=\"onClose()\">\r\n   <div class=\"cross\"></div>\r\n   <div class=\"cross\"></div>\r\n </div>\r\n</div>  \r\n\r\n<!-- \r\n\r\n    <div class=\"col\">\r\n      \r\n    </div>\r\n\r\n-->\r\n"
...
var ExploreDestComponent = (function () {
    function ExploreDestComponent(http) {
        this.http = http;
        this.onCloseRequest = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */]();
        this.COL_LENGTH = 6;
        this.browsedData = { COL_LENGTH: this.COL_LENGTH, list: [] };
        this.browsePath = '';
    }
    ExploreDestComponent.prototype.onClose = function () {
        this.onCloseRequest.emit('close');
    };
    ExploreDestComponent.prototype.resetBrowawePath = function () {
        this.browsePath = '';
    };
    ExploreDestComponent.prototype.geArrayVersionOfGivenContainers = function () {
        return __WEBPACK_IMPORTED_MODULE_1__services_common_util_service__["a" /* CommonUtilService */].toRepeatable(this.givenContainers);
    };
    ExploreDestComponent.prototype.populateResources = function () {
        var _this = this;
        var dataToPost = { containerURI: this.browsePath };
        __WEBPACK_IMPORTED_MODULE_1__services_common_util_service__["a" /* CommonUtilService */].getSpecificResourceList(this.http, dataToPost, function (data) {
            var max_iter, tick = 0;
            _this.browsedData = { COL_LENGTH: _this.COL_LENGTH, list: [] };
            if (data.length > 0) {
                max_iter = Math.ceil(data.length / _this.browsedData.COL_LENGTH);
                for (var i = 0; i < max_iter; i++) {
                    for (var w = 0; w < _this.browsedData.COL_LENGTH; w++) {
                        if (!_this.browsedData.list[w]) {
                            _this.browsedData.list[w] = [];
                        }
                        if (tick < data.length) {
                            if (!data[tick].isDir) {
                                data[tick].path = __WEBPACK_IMPORTED_MODULE_1__services_common_util_service__["a" /* CommonUtilService */].masterConfig.connection.serviceRequestHost + (data[tick].path.replace('./', '/'));
                            }
                            _this.browsedData.list[w].push(data[tick]);
                        }
                        tick++;
                    }
                }
    ...
    ExploreDestComponent.prototype.setBrowsePath = function (path) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["R" /* Output */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */]) === "function" && _a || Object)
], ExploreDestComponent.prototype, "onCloseRequest", void 0);
...
var CommonUtilService = (function () {
    ...
    CommonUtilService.getSpecificResourceList = function (http, dataToPost, success, error) {
        var requestPath = this.masterConfig.connection.serviceRequestHost + '/service/jobs/analyzeanyfolder';
        var analyzeObservable = http.post(requestPath, dataToPost);
        analyzeObservable.subscribe(function (jsonData) {
            success(jsonData);
        }, function (err) {
            error(err);
        });
